...
export function SettingsPopover({
    ...
    const renderMainScreen = () => (
        <div className="settings-popover__content">
            ...
            <div className="settings-popover__menu">
                ...
                >
                    <GoabIcon type={LAYOUT_OPTIONS.find(o => o.value === settings.layout)?.icon || 'menu'} size="small" />
                ...
                {settings.layout === 'table' && !isMobile && (
                    ...
                    >
                        ...
                        <span className="settings-popover__menu-value">{settings.visibleColumns.length}</span>
                        <GoabIcon type="chevron-forward" size="small" />
                    </button>
                )}
    ...
    const renderLayoutScreen = () => (
        <div className="settings-popover__content">
            <div className="settings-popover__header">
                <button
                    className="settings-popover__back"
                ...
                >
                    {LAYOUT_OPTIONS.map(option => (
                        <GoabRadioItem
                            key={option.value}
                            value={option.value}
                            label={option.value === defaultLayout ? `${option.label} (Default)` : option.label}
                        />
                    ))}
                </GoabRadioGroup>
            </div>
