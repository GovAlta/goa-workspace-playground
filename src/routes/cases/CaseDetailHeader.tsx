  ...
  return (
    ...
    <div className="case-detail-header__tombstone">
        ...
        <div className="case-detail-header__badges">
            {isLoading ? (
              <div style={{ display: "flex", gap: "var(--goa-space-s)", alignItems: "center" }}>
        ...
        <div className="case-detail-header__id">
            {isLoading ? (
              ...
              <>
                ...
                <GoabTooltip content={copiedField === 'phoneNumber' ? 'Copied' : 'Copy'}><GoabIconButton icon="copy" ariaLabel="Copy Phone Number" variant="dark" size="small" onClick={() => handleCopy(phoneNumber, 'phoneNumber')}/></GoabTooltip>
              </>
            )}
        </div>
    </div>
