            ...
            <div className="case-detail_form_double">
                ...
                <GoabxFormItem label="HS ID (Mobius ID)" mb="l">
                    <div style={{ display: "flex", alignItems: "center" }}>
                        ...
                        <GoabTooltip content={copiedField === 'hsId' ? 'Copied' : 'Copy'}><GoabIconButton icon="copy" ariaLabel="Copy HS ID" variant="dark" size="small" onClick={() => handleCopy(formData.hsId, 'hsId')}/></GoabTooltip>
                    </div>
                </GoabxFormItem>
            </div>
